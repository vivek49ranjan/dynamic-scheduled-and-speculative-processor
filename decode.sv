...
module decode ( 
    ...
    always_comb begin
        ...
        comb_dec.predicted_taken  = if_id_pred_taken;  
        comb_dec.predicted_target = if_id_pred_target; 
        ...
        case (rv_opcode)
            ...
            RV32_OP_IMM: begin
                ...
                case (rv_funct3)
                    3'b000:  comb_dec.opcode = OPCODE_ADD; 
                    3'b001:  comb_dec.opcode = OPCODE_SLL;     
                    3'b010:  comb_dec.opcode = OPCODE_COMPARE; 
                    3'b011:  comb_dec.opcode = OPCODE_COMPARE; 
                    3'b100:  comb_dec.opcode = OPCODE_XOR;     
